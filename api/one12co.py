...
def email_112co_report(
    ...
    """Email a stock research summary to the authenticated user."""
    sym = symbol.upper().strip()
    ...
    try:
        ...
        <body style="font-family: Arial, sans-serif; padding: 20px; color: #333;">
            <h2 style="color: #2563eb;">MRI Research Report: {sym}</h2>
            <hr style="border: 1px solid #e5e7eb;">
            <table style="width: 100%; border-collapse: collapse; margin-top: 16px;">
                <tr><td style="padding: 8px; font-weight: bold;">Price</td><td style="padding: 8px;">\u20b9{close:,.2f if close else 'N/A'}</td></tr>
                <tr style="background: #f9fafb;"><td style="padding: 8px; font-weight: bold;">MRI Score</td><td style="padding: 8px;">{score}/100</td></tr>
                <tr><td style="padding: 8px; font-weight: bold;">Breakout State</td><td style="padding: 8px;">{state}</td></tr>
                <tr style="background: #f9fafb;"><td style="padding: 8px; font-weight: bold;">EMA 50</td><td style="padding: 8px;">\u20b9{ema50:,.2f if ema50 else 'N/A'}</td></tr>
                <tr><td style="padding: 8px; font-weight: bold;">EMA 200</td><td style="padding: 8px;">\u20b9{ema200:,.2f if ema200 else 'N/A'}</td></tr>
            </table>
            <hr style="border: 1px solid #e5e7eb; margin-top: 20px;">
            <p style="font-size: 12px; color: #6b7280;">
                Generated by MRI Intelligence Platform | {sym} | {datetime.now().strftime('%Y-%m-%d %H:%M')}
            </p>
        </body>
        </html>
        """
