...
targets = [
    {"symbol": "INDGN", "pullback": 545, "breakout": 585},
    {"symbol": "CREDITACC", "pullback": 1490, "breakout": 1565},
    {"symbol": "TDPOWERSYS", "pullback": 1450, "breakout": 1600}
]
...
try:
    for t in targets:
        ...
        try:
            ...
            conn.rollback() # Rollback on failure to continue with others
